...
class FirstPersonCameraDemo {
  ...
  initializeAudio_() {
    ...
    loader.load("resources/music/calavera.mp3", (buffer) => {
      setTimeout(() => {
    ...
    loader.load("resources/music/Calavera 2.0.mp3", (buffer) => {
      setTimeout(() => {
  ...
  step_(timeElapsed) {
    ...
    if (
      this.analyzer2_ &&
      this.speaker2Material_ &&
      this.speaker2Material_.userData.shader
    ) {
      this.analyzer2_.getFrequencyData();
      this.speaker2Material_.userData.shader.uniforms.audioDataTexture.value =
        this.analyzer2Texture_;
      this.speaker2Material_.userData.shader.uniforms.iTime.value +=
        timeElapsedS;
